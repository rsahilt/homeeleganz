    ...
    <main>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <!-- form to edit the selected user -->
                ...
                <form action="{{ route('updateuser', ['id' => $user->id]) }}" novalidate 
                    ...
                    <div class="flex items-center mb-4">
                        <input id="is_admin" name="is_admin" type="checkbox"  class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $user->is_admin ? 'checked' : '' }}>
