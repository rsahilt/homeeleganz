                ...
                <form action=""
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select id="pst" name="pst" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option selected disabled>Select PST tax rate</option>
                                @foreach($filteredPstValues as $pstValue)
                                        <option value="{{ $pstValue }}" 
                                            @if($tax->pst === $pstValue) selected @endif>
                                            {{ $pstValue }}
                                        </option>
                                @endforeach
                            </select>
